...
# Because correlation is 0, I have to add a tiny constant. See what
# happens is you don't do this.
...
# Checking your first draft of your questionnaire
+ When checking data obtained using the first draft of your
  questionnaire, one thing to check is the variables you chose to
  measure some construct do measure that construct alone
...
+ We'll also about the loading matrix---sometimes called a lambda

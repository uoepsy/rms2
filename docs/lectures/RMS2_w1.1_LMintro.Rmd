---
title: "<b>Week 1: Introduction to Linear Model</b>"
subtitle: "RMS2<br><br> "
...
+ This week we will build from:
  + arithmetic mean
  + concept of squared deviations (see variability material in RMS1 recap)
...
---
# Linear model
+ What we will focus on for the entirety of RMS2 is how we move from the idea of an association, to estimating a model for the relationship.
